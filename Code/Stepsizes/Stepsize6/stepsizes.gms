...
if(steprule=1,stepsize =5;);   

*** constant step length
if(steprule=2,stepsize = 20/norm2;);

*** square summable but not summable
if(steprule=3,stepsize =6/(1+num_iter););

*** nonsummable diminishing
if(steprule=4,stepsize= 6/sqrt(num_iter););

*** nonsummable diminishing step length
if(steprule=5,stepsize= (30/num_iter)/norm2;);
