...
This is Step 8 of Algorithm 3 for solar model (Model I)
Before this file, we run the regularized problems - SAA_hi.gms to start Algorithm 3
$OFFTEXT
...
FILE fixed_profit /fixed_profit_hi.csv/;
fixed_profit.PC = 5;
fixed_profit.ND = 3;
PUT fixed_profit;
