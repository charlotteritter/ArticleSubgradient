...
This is Step 5 and 7 of Algorithm 3 for wind model (Model II)
After this file, we run fixed scenario problem - fixed_problem_hi.gms to finish Algorithm 3.
$OFFTEXT
...
TABLE WIND(W,T)
$ONDELIM
$INCLUDE ScenarioSet_hierarchical_wind7200.csv
$OFFDELIM
;

table probability(w,*)
$ONDELIM
$INCLUDE ScenarioWeights_hierarchical_wind7200.csv
$OFFDELIM
;
